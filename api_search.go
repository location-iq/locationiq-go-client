 ...
 * @param "Matchquality" (optional.Int32) -  Returns additional information about quality of the result in a matchquality object. Read more Defaults to 0 [0,1]
...
@return []Location
*/
func (a *SearchApiService) Search(ctx _context.Context, q string, format string, normalizecity int32, localVarOptionals *SearchOpts) ([]Location, *_nethttp.Response, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals.Matchquality.IsSet() {
		localVarQueryParams.Add("matchquality", parameterToString(localVarOptionals.Matchquality.Value(), ""))
	}
